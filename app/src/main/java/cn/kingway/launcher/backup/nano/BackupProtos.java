...
package cn.kingway.launcher.backup.nano;
...
public interface BackupProtos {
  ...
  public static final class Key extends
    ...
    public Key clear() {
      type = cn.kingway.launcher.backup.nano.BackupProtos.Key.FAVORITE;
      name = "";
      id = 0L;
      checksum = 0L;
      cachedSize = -1;
      ...
      while (true) {
        ...
        switch (tag) {
          ...
          case 8: {
            ...
            switch (value) {
              case cn.kingway.launcher.backup.nano.BackupProtos.Key.FAVORITE:
              case cn.kingway.launcher.backup.nano.BackupProtos.Key.SCREEN:
              case cn.kingway.launcher.backup.nano.BackupProtos.Key.ICON:
              case cn.kingway.launcher.backup.nano.BackupProtos.Key.WIDGET:
                this.type = value;
                break;
            }
            break;
  ...
  public static final class Journal extends
    ...
    public cn.kingway.launcher.backup.nano.BackupProtos.Key[] key;

    // optional int32 backup_version = 6 [default = 1];
    public int backupVersion;

    // optional .launcher_backup.DeviceProfieData profile = 7;
    public cn.kingway.launcher.backup.nano.BackupProtos.DeviceProfieData profile;
    ...
    public Journal clear() {
      ...
      bytes = 0L;
      rows = 0;
      key = cn.kingway.launcher.backup.nano.BackupProtos.Key.emptyArray();
      backupVersion = 1;
      profile = null;
      cachedSize = -1;
      return this;
    ...
    public void writeTo(com.google.protobuf.nano.CodedOutputByteBufferNano output)
      ...
      if (this.key != null && this.key.length > 0) {
        for (int i = 0; i < this.key.length; i++) {
          cn.kingway.launcher.backup.nano.BackupProtos.Key element = this.key[i];
          if (element != null) {
      ...
      while (true) {
        ...
        switch (tag) {
          ...
          case 42: {
            ...
            cn.kingway.launcher.backup.nano.BackupProtos.Key[] newArray =
                new cn.kingway.launcher.backup.nano.BackupProtos.Key[i + arrayLength];
            if (i != 0) {
              System.arraycopy(this.key, 0, newArray, 0, i);
            }
            for (; i < newArray.length - 1; i++) {
              newArray[i] = new cn.kingway.launcher.backup.nano.BackupProtos.Key();
          ...
          case 58: {
            if (this.profile == null) {
              this.profile = new cn.kingway.launcher.backup.nano.BackupProtos.DeviceProfieData();
            }
  ...
  public static final class Favorite extends
    ...
    public Favorite clear() {
      ...
      targetType = cn.kingway.launcher.backup.nano.BackupProtos.Favorite.TARGET_NONE;
      rank = 0;
      cachedSize = -1;
      return this;
    }
    ...
    public void writeTo(com.google.protobuf.nano.CodedOutputByteBufferNano output)
      ...
      if (this.targetType != cn.kingway.launcher.backup.nano.BackupProtos.Favorite.TARGET_NONE) {
      ...
      while (true) {
        ...
        switch (tag) {
          ...
          case 152: {
            int value = input.readInt32();
            switch (value) {
              case cn.kingway.launcher.backup.nano.BackupProtos.Favorite.TARGET_NONE:
              case cn.kingway.launcher.backup.nano.BackupProtos.Favorite.TARGET_PHONE:
              case cn.kingway.launcher.backup.nano.BackupProtos.Favorite.TARGET_MESSENGER:
              case cn.kingway.launcher.backup.nano.BackupProtos.Favorite.TARGET_EMAIL:
              case cn.kingway.launcher.backup.nano.BackupProtos.Favorite.TARGET_BROWSER:
              case cn.kingway.launcher.backup.nano.BackupProtos.Favorite.TARGET_GALLERY:
              case cn.kingway.launcher.backup.nano.BackupProtos.Favorite.TARGET_CAMERA:
  ...
  public static final class Widget extends
    ...
    public cn.kingway.launcher.backup.nano.BackupProtos.Resource icon;

    // optional .launcher_backup.Resource preview = 5;
    public cn.kingway.launcher.backup.nano.BackupProtos.Resource preview;
    ...
    public Widget mergeFrom(
      ...
      while (true) {
        ...
        switch (tag) {
          ...
          case 34: {
            if (this.icon == null) {
              this.icon = new cn.kingway.launcher.backup.nano.BackupProtos.Resource();
            }
          ...
          case 42: {
            if (this.preview == null) {
              this.preview = new cn.kingway.launcher.backup.nano.BackupProtos.Resource();
            }
