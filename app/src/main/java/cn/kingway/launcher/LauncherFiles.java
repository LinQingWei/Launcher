...
public class LauncherFiles {
    ...
    public static final String SHARED_PREFERENCES_KEY = "cn.kingway.launcher.prefs";
    public static final String WALLPAPER_CROP_PREFERENCES_KEY =
            "cn.kingway.launcher.WallpaperCropActivity";
    public static final String MANAGED_USER_PREFERENCES_KEY = "cn.kingway.launcher.managedusers.prefs";
    ...
    public static final List<String> OBSOLETE_FILES = Collections.unmodifiableList(Arrays.asList(
            ...
            "cn.kingway.launcher.compat.PackageInstallerCompatV16.queue"));
}
